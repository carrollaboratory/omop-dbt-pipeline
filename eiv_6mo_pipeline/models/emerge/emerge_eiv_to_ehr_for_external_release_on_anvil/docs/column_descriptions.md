{% docs emerge_person_ex_release_20260401_emerge_id %}
Unique de-identified eMERGE ID formatted as SITE_ID + 5 digit randomized Ex: 2713331; 7 total digits
{% enddocs %}

{% docs emerge_person_ex_release_20260401_withdrawal_status %}
Participant's withdrawal status
{% enddocs %}

{% docs emerge_person_ex_release_20260401_year_of_birth %}
Participant year of birth for age calcuation and quality control purposes
{% enddocs %}

{% docs emerge_person_ex_release_20260401_gender_concept_id %}
...
{% docs emerge_person_ex_release_20260401_race_concept_id %}
This field captures race or ethnic background of the person.
{% enddocs %}

{% docs emerge_person_ex_release_20260401_ethnicity_concept_id %}
...
{% docs emerge_measurement_ex_release_20260922_emerge_id %}
Unique de-identified eMERGE ID formatted as SITE_ID + 5 digit randomized Ex: 2713331; 7 total digits
{% enddocs %}

{% docs emerge_measurement_ex_release_20260922_measurement__5f480161 %}
This is the standard concept mapped from the source value which represents a measurement
{% enddocs %}

{% docs emerge_measurement_ex_release_20260922_value_as_number %}
This is the numerical value of the result of the measurement
{% enddocs %}

{% docs emerge_measurement_ex_release_20260922_value_as_text %}
This is the text value of the result of the measurement
{% enddocs %}

{% docs emerge_measurement_ex_release_20260922_range_low %}
...
{% docs emerge_measurement_ex_release_20260922_range_high %}
...
{% docs emerge_measurement_ex_release_20260922_range_flag %}
Flag indicating a lab result is lower or higher than a normal value
{% enddocs %}

{% docs emerge_measurement_ex_release_20260922_unit_concept_id %}
...
{% docs emerge_measurement_ex_release_20260922_unit_concept_as_text %}
Measurement unit text value
{% enddocs %}

{% docs emerge_measurement_ex_release_20260922_row_id %}
Unique number differentiating identical rows to avoid duplicate rows in data file
{% enddocs %}

{% docs emerge_measurement_ex_release_20260922_encounter_id %}
...
{% docs emerge_measurement_ex_release_20260922_gira_ror %}
A flag indicating if an encounter occurred before or after participant GIRA return
{% enddocs %}

{% docs emerge_bmi_ex_release_20260922_emerge_id %}
Unique de-identified eMERGE ID formatted as SITE_ID + 5 digit randomized
 Ex: 2713331; 7 total digits
{% enddocs %}

{% docs emerge_bmi_ex_release_20260922_age_at_event %}
Age of participant at time of BMI measurement occurrence
{% enddocs %}

{% docs emerge_bmi_ex_release_20260922_measurement_concept_id %}
This is the standard concept mapped from the source value which represents a measurement
{% enddocs %}

{% docs emerge_bmi_ex_release_20260922_measurement_concept_name %}
Name of measurement mapped from MEASUREMENT_CONCEPT_ID
{% enddocs %}

{% docs emerge_bmi_ex_release_20260922_value_as_number %}
This is the numerical value of the result of the measurement
{% enddocs %}

{% docs emerge_bmi_ex_release_20260922_unit_concept_id %}
...
{% docs emerge_bmi_ex_release_20260922_unit_concept_name %}
Name of unit used to express the value of a measurement or observation
{% enddocs %}

{% docs emerge_bmi_ex_release_20260922_bmi_z_score %}
Gender adjusted Z-Score and age adjusted for pediatrics
{% enddocs %}

{% docs emerge_bmi_ex_release_20260922_row_id %}
Unique number differentiating identical rows to avoid duplicate rows in data file
{% enddocs %}

{% docs emerge_bmi_ex_release_20260922_encounter_id %}
Indicates a sequence of events for same age encounters (events that occur on the same day for an eMERGE ID have the same encounter number)
{% enddocs %}

{% docs emerge_bmi_ex_release_20260922_gira_ror %}
A flag indicating if an encounter occurred before or after participant GIRA return
{% enddocs %}

{% docs emerge_cpt_ex_release_20260922_emerge_id %}
Unique de-identified eMERGE ID formatted as SITE_ID + 5 digit randomized
 Ex: 2713331; 7 total digits
{% enddocs %}

{% docs emerge_cpt_ex_release_20260922_age_at_event %}
Age of participant at time of CPT occurrence
{% enddocs %}

{% docs emerge_cpt_ex_release_20260922_cpt_code %}
Indicates the originating CPT code
{% enddocs %}

{% docs emerge_cpt_ex_release_20260922_row_id %}
Unique number differentiating identical rows to avoid duplicate rows in data file
{% enddocs %}

{% docs emerge_cpt_ex_release_20260922_encounter_id %}
Indicates a sequence of events for same age encounters (events that occur on the same day for an eMERGE ID have the same encounter number)
{% enddocs %}

{% docs emerge_cpt_ex_release_20260922_gira_ror %}
A flag indicating if an encounter occurred before or after participant GIRA return
{% enddocs %}

{% docs emerge_icd_ex_release_20260922_emerge_id %}
Unique de-identified eMERGE ID formatted as SITE_ID + 5 digit randomized
 Ex: 2713331; 7 total digits
{% enddocs %}

{% docs emerge_icd_ex_release_20260922_age_at_event %}
Age of participant at time of ICD occurrence
{% enddocs %}

{% docs emerge_icd_ex_release_20260922_icd_code %}
Indicates the originating ICD code
{% enddocs %}

{% docs emerge_icd_ex_release_20260922_icd_flag %}
Numeric flag, should indicate if code is a 9 or 10
{% enddocs %}

{% docs emerge_icd_ex_release_20260922_row_id %}
Unique number differentiating identical rows to avoid duplicate rows in data file
{% enddocs %}

{% docs emerge_icd_ex_release_20260922_encounter_id %}
Indicates a sequence of events for same age encounters (events that occur on the same day for an eMERGE ID have the same encounter number)
{% enddocs %}

{% docs emerge_icd_ex_release_20260922_gira_ror %}
A flag indicating if an encounter occurred before or after participant GIRA return
{% enddocs %}
