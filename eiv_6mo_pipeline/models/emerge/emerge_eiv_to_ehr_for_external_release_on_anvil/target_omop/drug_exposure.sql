...
with base as (
    ...
    date_add(vo.birth_date, INTERVAL (vo.age_at_event_split) YEAR)::date as "drug_exposure_start_date",
    null::timestamp as "drug_exposure_start_datetime",
    date_add(vo.birth_date, INTERVAL (vo.age_at_event_split) YEAR)::date::text as "drug_exposure_end_date",
