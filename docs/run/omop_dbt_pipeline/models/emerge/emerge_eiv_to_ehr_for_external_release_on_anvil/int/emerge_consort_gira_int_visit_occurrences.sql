    ...
    create  table
      "dbt"."dev_202609_6mo_int"."emerge_consort_gira_int_visit_occurrences__dbt_tmp"
...
with unioned as (
    ...
    where emerge_id not in (select emerge_id from "dbt"."dev_202609_6mo_lookups"."emerge_consort_gira_lookup_exclusion") and age_at_event is not null
    union
    select emerge_id, encounter_id, age_at_event
...
from add_index
left join (select emerge_id, birth_date from "dbt"."dev_202609_6mo_int"."emerge_consort_gira_int_person_persons" )
using (emerge_id)
    );
