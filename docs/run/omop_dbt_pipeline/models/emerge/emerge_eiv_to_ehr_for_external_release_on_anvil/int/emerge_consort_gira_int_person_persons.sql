    ...
    create  table
      "dbt"."dev_202609_6mo_int"."emerge_consort_gira_int_person_persons__dbt_tmp"
...
from "dbt"."dev_202609_6mo_src"."emerge_consort_gira_src_emerge_person_ex_release_20260123" src
...
where src.emerge_id not in (select emerge_id from "dbt"."dev_202609_6mo_lookups"."emerge_consort_gira_lookup_exclusion")
group by
    src.emerge_id,
    src.withdrawal_status,
    src.year_of_birth,
