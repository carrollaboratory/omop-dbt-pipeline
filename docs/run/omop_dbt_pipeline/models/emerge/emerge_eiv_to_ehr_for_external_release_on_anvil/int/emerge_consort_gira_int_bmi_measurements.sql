    ...
    create  table
      "dbt"."dev_202609_6mo_int"."emerge_consort_gira_int_bmi_measurements__dbt_tmp"
...
select
    ...
    gira_ror,
    src_index
from "dbt"."dev_202609_6mo_src"."emerge_consort_gira_src_emerge_bmi_ex_release_20260128" src
