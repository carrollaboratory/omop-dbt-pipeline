    ...
    create  table
      "dbt"."dev_202609_6mo_int"."emerge_consort_gira_int_cpt_observations__dbt_tmp"
    ...
    gira_ror,
    src_index,
    FROM "dbt"."dev_202609_6mo_src"."emerge_consort_gira_src_emerge_cpt_ex_release_20260129" src
