    ...
    create  table
      "dbt"."dev_202609_6mo_lookups"."emerge_consort_gira_lookup_exclusion__dbt_tmp"
...
where emerge_id not in (select distinct emerge_id from "dbt"."dev_202609_6mo_src"."emerge_consort_gira_src_emerge_person_ex_release_20260123")
and emerge_id not in (select distinct emerge_id from "dbt"."dev_202609_6mo_src"."emerge_consort_gira_src_emerge_6_month_consent_ds_20260731" where consent = '1')
    );
