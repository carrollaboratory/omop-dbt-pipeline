    ...
    create  table
      "dbt"."dev_202609_6mo_lookups"."emerge_consort_gira_lookup_standards__dbt_tmp"
    ...
    filtered_concept as (
        ...
        vocabulary_id,
        concept_id_2
        from "dbt"."dev_202609_6mo_lookups"."emerge_consort_gira_lookup_concepts" c
        left join (select *,
            from "dbt"."dev_202609_vocab"."CONCEPT_RELATIONSHIP" cr
    ...
    left join (select
               ...
               concept_code,
               domain_id
               from "dbt"."dev_202609_vocab"."CONCEPT"
               ) as c
