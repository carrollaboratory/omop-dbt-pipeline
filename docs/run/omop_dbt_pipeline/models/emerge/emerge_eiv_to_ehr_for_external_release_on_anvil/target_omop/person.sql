    ...
    create  table
      "dbt"."dev_202609_omop"."person__dbt_tmp"
    ...
    CAST(200000000 AS INTEGER) + CAST(CONCAT('999', substring(emerge_id, 1, 2)) AS INTEGER)::integer as "care_site_id",
    ...
    from "dbt"."dev_202609_6mo_int"."emerge_consort_gira_int_person_persons"
    );
