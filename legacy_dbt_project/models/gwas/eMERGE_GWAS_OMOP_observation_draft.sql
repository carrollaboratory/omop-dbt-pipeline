...
SELECT
    ...
    "value_source_concept_id"::TEXT AS "value_source_concept_id",
    "value_source_value"::TEXT AS "value_source_value"
FROM read_csv('../../_study_data/emerge_legacy/eMERGE_GWAS_OMOP_observation_draft.csv', AUTO_DETECT=FALSE, HEADER=TRUE, nullstr = ["null", "NA", "N/A"], columns={
        ...
        'value_source_concept_id': 'VARCHAR',
